...
import { getFirebaseConnection, shouldUseDemoMode } from '../firebase/firebaseConnection.js';
...
async function loadFirebase() {
  ...
  return {
    authSdk: connection.authSdk,
    firestoreSdk: connection.firestoreSdk,
    storageSdk: connection.storageSdk
  };
}


export const firebaseService = {
  mode: shouldUseDemoMode() ? 'demo' : 'firebase',
